...
echo sprintf( esc_html__( 'Designed with %1$sWordPress.%2$s', 'urbem' ), '<a rel="noreferrer noopener" href="' . esc_url( 'http://wordpress.org' ) . '" data-type="URL" data-id="wordpress.org" target="_blank">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->